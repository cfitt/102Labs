...
object_t *object_init(FILE  *in, model_t  *model);
...
object_t *plane_init(FILE  *in, model_t  *model, int  attrmax);
...
object_t *tplane_init(FILE  *in, model_t  *model);

void tp_amb(object_t  *obj, drgb_t  value);
void tp_diff(object_t  *obj, drgb_t  value);
void tp_spec(object_t  *obj, drgb_t  value);


/* = = = = = = = = = = = = = = = pplane.c = = = = = = = = = = = = = = = */
/* = = = = = = = = = =  a derived type of plane = = = = = = = = = = = = */

object_t *pplane_init(FILE  *in, model_t  *model, int  attrmax);
...
object_t *sphere_init(FILE  *in, model_t  *model, int  attrmax);
